...
class UsuarioServiceTest {
    ...
    @Nested
    @DisplayName("Testes dos métodos find by Id")
    class FindById {
        @Test
    ...
    @Nested
    @DisplayName("Testes dos métodos save")
    class Save {
        @Test
    ...
    @Nested
    @DisplayName("Testes dos métodos update")
    class Update {
        @Test
    ...
    @Nested
    @DisplayName("Testes dos métodos delete")
    class Delete {
        @Test
    ...
    @Nested
    @DisplayName("Testes dos métodos find by email")
    class FindByEmail {
        @Test
    ...
    @Nested
    @DisplayName("Testes dos métodos find all")
    class FindAll {
        @Test
    ...
    @Test
    @Disabled("Teste desativado temporariamente devido à refatoração de perfis.")
    @DisplayName("TESTE DESATIVADO: Exemplo de teste a ser ignorado.")
    void someTestToBeIgnored() {
        Assertions.fail("Esta falha nunca será alcançada se o teste estiver desativado.");
    }
}